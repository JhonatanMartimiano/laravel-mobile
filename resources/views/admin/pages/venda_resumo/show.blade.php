...
@section('title', 'Vendas Resumidas')

@section('content')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Vendas Resumidas</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item" href="javascript:void(0)">Vendas Resumidas</li>
    ...
    <div class="card">
        ...
        <section class="card-body">
            <form class="ajax_submit" action="{{ route('venda-resumo.pesquisar.do') }}" method="POST" enctype="multipart/form-data">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="form-group">
                            <label for="">Tipo do relatório</label>
                            <select class="form-control" name="tipo_relatorio" id="tipo_relatorio" required>
                                <option value="dia" selected>Agrupado por dia</option>
                                <option value="bandeira">Agrupado por bandeira</option>
                                <option value="operadora">Agrupado por operadora</option>
                            </select>
                        </div>
                    </div>
                </div>
